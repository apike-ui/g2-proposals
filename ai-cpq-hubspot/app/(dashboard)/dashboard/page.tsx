...
export default function DashboardPage() {
  ...
  const statCards = [
    { label: 'Total Products', value: stats.totalProducts, icon: '📦', href: '/products', color: 'bg-blue-50 text-blue-700' },
    { label: 'Active Quotes', value: stats.totalQuotes, icon: '📄', href: '/quotes', color: 'bg-purple-50 text-purple-700' },
    { label: 'Orders', value: stats.totalOrders, icon: '🛒', href: '/orders', color: 'bg-green-50 text-green-700' },
    {
      label: 'Revenue (Completed)',
      value: `$${stats.totalRevenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}`,
      icon: '💰', href: '/orders', color: 'bg-amber-50 text-amber-700',
    },
  ]
